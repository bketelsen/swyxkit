...
<nav
	class="flex items-center justify-between w-full relative max-w-2xl border-base-200 dark:border-gray-700 mx-auto py-8 sm:pb-16 text-base-content bg-base-100  bg-opacity-60 "
>
